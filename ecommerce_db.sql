...
-- USERS
-- Mật khẩu mặc định đã được mã hóa bằng bcrypt:
-- admin@example.com: Admin@123456
-- staff@example.com: Staff@123456
-- customer@example.com: Customer@123456
-- customer2@example.com: Customer2@123456
INSERT INTO users (name, email, password, phone) VALUES
('Nguyen Van A', 'admin@example.com', '$2b$10$AL/1BNdB5vOOws7wUvhVtOVakNeFpPexn4DliHpSI.u0Ddldvji0.', '0901111222'),
('Tran Thi B', 'staff@example.com', '$2b$10$NvWPBcOHbuVpVUUZ.g9Kiu5L59saDDNSSsD0Pm88tWU9pVz/D.Soa', '0903333444'),
('Le Van C', 'customer@example.com', '$2b$10$KMvtb7.PAcOiaTulMN2w.uqIzJHdqqZmZeUXEjsxY0U3Z0X/bw0mq', '0905555666'),
('Pham Thi D', 'customer2@example.com', '$2b$10$baabc7TsF3cb8A5us20tYeN6GjC5neGvjw4UMSY7EGCBxXnRf.ZEG', '0907777888');
